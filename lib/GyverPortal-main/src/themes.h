...
h2{margin:8px 0;color:#32BAC2; font-size: 2.0em;}
span{font-size:16px;}
...
.blockHeader{font-size:22px;color:#fff;border-radius:10px 10px 0px 0px;background-color:#32BAC2;padding:6px 0px;margin:0 -11px 10px -11px;}
...
.inliner-width{flex-direction:row;align-content:center;flex-wrap:nowrap;align-items:center;}
...
width:100%;border-radius:8px;padding:3px 10px;color:#bbb;border:none;background-color:#2a2d35;vertical-align:middle;position:relative;margin:6px 4px;font-size:20px;height:40px;cursor:pointer;}
...
input[type=submit],input[type=button],button{height:55px;font-size:24px;width:95%;margin:8px 5px;background-color:#32BAC2;border:none;border-radius:8px;color:white;cursor:pointer;padding:0px 10px;}
...
input:checked+.slider{background-color:#32BAC2}
input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}
output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#32BAC2;margin-right:5px;}
input[type=range]{max-width:250px;-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#fff;border:1px #b5b5b5 solid;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#32BAC2,#32BAC2);}
...
.display{display:inline-block;font-size:18px;padding:0.1em 0.2em;color:#fff;background:#32BAC2;margin:2px 3px;}
#ubtn{width: 100%; padding: 10px 15px 1px 0px;height:40px;font-size:25px;margin:8px 5px;background-color:#32BAC2;border:none;border-radius:8px;color:white;cursor:pointer;text-align:center;vertical-align:middle;}
#ubtn:hover{filter:brightness(0.9);}
#ubtnclr{height:0px;width:0px;overflow:hidden;}
.navtab>ul{display:flex;flex-wrap:wrap;align-items:stretch;justify-content:center;list-style-type:none;margin:15px 0;padding:0;overflow:hidden;border-radius:5px;background:#32BAC2;}
...
details>summary{font-size:18px;background-color:#32BAC2;color:black;cursor:pointer;padding:10px 15px;border-radius:6px;user-select:none;}
details[open]>summary{border-radius:6px 6px 0 0;}
details>summary>*{display:inline;}
details>div{border:2px solid #32BAC2;padding:10px;border-radius:0 0 4px 4px;}
...
.eyepass{position:absolute;margin-left:-35px;margin-top:7px;cursor:pointer;font-size:25px;color:#000;}
...
.check_c>input:checked+span::before{border-color:#32BAC2;background-color:#32BAC2;background-image:url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath d='m12.82,3l-6.6,6.6l-3,-3-1.9,1.9l5,5.00687l8.5,-8.5-1.9,-1.9z' fill='%23fff'/%3e%3c/svg%3e");}
...
.rad:after{width:15px;height:15px;border-radius:50%;top:2px;left:3px;position:relative;content:'';display:inline-block;border-style:solid;border-width:2px;border-color:#32BAC2;}
.rad:checked:after{background-color:#32BAC2;}
)";
...
p{display:inline;}
.mainblock{margin:auto;max-width:100%}
a,a:visited{color:#32BAC2}
a:hover{color:#3d9941}
#blockBack input[type=password],#blockBack input[type=text],#blockBack input[type=date],#blockBack input[type=time],#blockBack input[type=number],#blockBack textarea,#blockBack select,#blockBack .slider{background:#000}
#blockBack input[type=range]{background:#000;background-repeat:no-repeat;}
#blockBack input:checked+.slider{background-color:#32BAC2}
body{font-family:Verdana;background:#000;color:#bbb;margin-top:15px;}
...
.blockTab{padding-top:0px;}
.blockHeader{color:#000;font-size:22px;border-radius:10px 10px 0px 0px;background-color:#32BAC2;padding:6px 0px;margin:0px -11px 10px -11px;}
.thinBlock{background:none;border:2px solid #3c4048;}
.thinText{padding:0px 10px;background:#000;font-size:20px;}
.thinTab{background:none;border:none;color:#9c9ea1;margin-top:-17px;margin-bottom:5px;display:block;}
.inliner{display:flex;flex-direction:row;align-content:center;flex-wrap:nowrap;align-items:center;}
.inliner-width{flex-direction:row;align-content:center;flex-wrap:nowrap;align-items:center;}
input[type=number],input[type=text],input[type=password],input[type=date],input[type=time],input[type=color],input[type=checkbox],select,textarea{
...
textarea{width:auto;max-width:100%}
input[type=submit],input[type=button],button{height:55px;font-size:24px;width:95%;margin:8px 5px;background-color:#32BAC2;border:none;border-radius:8px;color:white;cursor:pointer;}
input[type=submit]:hover,input[type=button]:hover,button:hover{filter:brightness(0.95);}
input[type=button],button{display:flex;align-items:center;justify-content:center;}
input[type=submit]:active,input[type=button]:active,button:active{box-shadow:inset 0px 1px 6px #0007;}
...
input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}
output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#32BAC2;margin-right:5px;}
input[type=range]{max-width:250px;-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#2a2d35;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#32BAC2,#32BAC2);}
input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;height:15px;width:15px;}
input[type=range]:hover{filter:brightness(0.93);}
.display{display:inline-block;font-size:18px;padding:0.1em 0.2em;color:#000;background:#32BAC2;margin:2px 3px;}
#ubtn{width: 100%; padding: 10px 15px 1px 0px;height:40px;font-size:25px;margin:8px 5px;background-color:#32BAC2;border:none;border-radius:8px;color:white;cursor:pointer;text-align:center;vertical-align:middle;}
#ubtn:hover{filter:brightness(0.9);}
#ubtnclr{height:0px;width:0px;overflow:hidden;}
.navtab>ul{display:flex;flex-wrap:wrap;align-items:stretch;justify-content:center;list-style-type:none;margin:15px 0;padding:0;overflow:hidden;border-radius:5px;background:#32BAC2;}
...
.spinR{border-radius:0 8px 8px 0!important;right:10px;}
#spinner input[type=number]{width:60px;border-radius:0px;text-align:center;}
details>summary{font-size:18px;background-color:#32BAC2;color:white;cursor:pointer;padding:10px 15px;border-radius:6px;user-select:none;}
details[open]>summary{border-radius:6px 6px 0 0;}
details>summary>*{display:inline;}
details>div{border:2px solid #32BAC2;padding:10px;border-radius:0 0 4px 4px;}
textarea::-webkit-scrollbar{width:6px;}
